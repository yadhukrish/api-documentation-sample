...
## Repository Contents
* **[Current Weather API Guide](./openweather-api-guide.md):** The primary documentation for the Current Weather endpoint, including authentication, parameters, and JSON schemas.
* **[Error Handling](./openweather-api-guide.md#error-handling):** A categorized guide for troubleshooting failed API requests based on HTTP status codes.
